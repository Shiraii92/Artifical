<template>
  <div class="w-full">
    <!-- Hero section -->
    <section id="hero" class="md:justify-end flex flex-col justify-center pt-0 bg-gradient-to-bl from brand to-yellow-0 h-screen pb-20 lg:overflow-hidden relative">
      <BaseSection>
